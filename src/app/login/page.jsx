...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      router.push('/homepage'); // Redirect to beranda page after successful login
    } catch (error) {
  ...
  const handleSocialLogin = (provider) => {
    // This is just a mock function for the social login buttons
    alert(`Login dengan ${provider} akan segera hadir!`);
  };

  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-green-100 py-12 px-4 sm:px-6 lg:px-8 flex items-center">
        ...
        <div className="text-center">
          <div className="flex justify-center mb-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold text-green-600">AgroCycle</span>
            </div>
          </div>
